        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 pr-10 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-black"
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 text-sm text-gray-600 bg-gray-50 p-4 rounded-md">
              <p className="font-medium text-gray-700 mb-2">For testing:</p>
